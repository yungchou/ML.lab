...
* [Model Comparison](#comparison), [3D Views](#3d)
...
- **Data Set**
The data set was downloaded from [Kaggle House Prices:](https://www.kaggle.com/c/house-prices-advanced-regression-techniques/data)  Advanced Regression Techniques. There were two files: train.csv with 1460 observations and 81 variables, while test.csv with ???? observations of the label, SalePrice.
...
- **Numeric Variables**
There were some extreme values among numeric variables in the train data set due to the way the values were captures. For instance, those measures such as deck, porch or pool ranges from 0 when not applicable to hundreds in squared footage. When modeling these variables as predictors, those with large values might overwhelm and skew the model. These variables were minimized to just a few levels and converted to numbers better reflect real-world scenatios. Above all, the strategies to select what and determine how to convert a variable have much to do with the composition and distribution of the data. Often, the values of a variable is not as significant as the variance of those values.
...
```{r out.width='50%'}
knitr::include_graphics(paste0(wd,"/m1.lm.residuals.keeper.jpeg"))
```
...
#### 2.1 Regularization
```{r out.width='50%'}
knitr::include_graphics(paste0(wd,"/m2.ridge.tuning.keeper.jpeg"))
```
...
```{r out.width='50%'}
knitr::include_graphics(paste0(wd,"/m2.ridge.residuals.keeper.jpeg"))
```
...
#### 3.1 Regularization
```{r out.width='50%'}
knitr::include_graphics(paste0(wd,"/m3.lasso.tuning.keeper.jpeg"))
```
...
```{r out.width='50%'}
knitr::include_graphics(paste0(wd,"/m3.lasso.residuals.keeper.jpeg"))
```
...
#### 4.1 Regularization
```{r out.width='100%'}
knitr::include_graphics(paste0(wd,"/m4.elastic.tuning.keeper.1280.jpeg"))
```
...
```{r out.width='50%'}
knitr::include_graphics(paste0(wd,"/m4.elastic.residuals.keeper.jpeg"))
```
...
## <a name="comparison"/>Model Comparision
[(back)](#back)

### Boxplots
```{r out.width='50%'}
knitr::include_graphics(paste0(wd,"/m5.model.comparison.rmse.jpeg"))
knitr::include_graphics(paste0(wd,"/m5.model.comparison.rsquared.jpeg"))
knitr::include_graphics(paste0(wd,"/m5.model.comparison.mae.jpeg"))
```

## <a name='3d'/>3D Scalttle Plots
[(back)](#back)
